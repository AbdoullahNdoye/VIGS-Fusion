...
namespace gaussian_splatting_slam
{
    ...
    ResidualBlockInfo::ResidualBlockInfo(ceres::CostFunction *_cost_function,
        ...
        : cost_function(_cost_function), loss_function(_loss_function), parameter_blocks(_parameter_blocks), drop_set(_drop_set), raw_jacobians(0)
    {
    ...
    void MarginalizationInfo::marginalize()
    {
        ...
        */
        ...
        //     std::cout << "A* : " << A_star << std::endl;
        //     std::cout << "b* : " << b_star << std::endl;
        ...
        //                << std::endl;
        //     std::cout << "linearized_jacobians : " << std::endl << linearized_jacobians << std::endl;
        //     std::cout << "linearized_residuals : " << std::endl << linearized_residuals.transpose() << std::endl;
    ...
    void MarginalizationFactor::init(MarginalizationInfo *_marginalization_info)
    {
        ...
        //     std::cout << "residual size: " << cnt << ", " << marginalization_info->n << std::endl;
    ...
    bool MarginalizationFactor::Evaluate(double const *const *parameters, double *residuals, double **jacobians) const
    {
        ...
        // 	      << "parameter number : " << marginalization_info->keep_block_size.size() << std::endl;
        //     std::cout << "MarginalizationFactor::Evaluate " << *parameters[0] << std::endl;
